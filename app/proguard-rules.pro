...
-keepclassmembers class com.kokeeu.siwoplayer.data.model.** { *; }
-keepclassmembers class com.kokeeu.siwoplayer.domain.model.** { *; }

-keepattributes Signature, InnerClasses, EnclosingMethod, AnnotationDefault, *Annotation*

# Cast framework classes loaded via manifest/reflective entry points.
-keep class com.kokeeu.siwoplayer.data.service.cast.CastOptionsProvider { *; }
...
-keep class com.kokeeu.siwoplayer.data.preferences.PreferenceBackupEntry { *; }
-keep class com.kokeeu.siwoplayer.data.backup.model.** { *; }
-keep class com.kokeeu.siwoplayer.data.backup.module.** { *; }
# Backup payload entities are part of the persisted .pxpl contract.
-keep class com.kokeeu.siwoplayer.data.database.FavoritesEntity { *; }
-keep class com.kokeeu.siwoplayer.data.database.SongEngagementEntity { *; }
-keep class com.kokeeu.siwoplayer.data.database.LyricsEntity { *; }
-keep class com.kokeeu.siwoplayer.data.database.SearchHistoryEntity { *; }
-keep class com.kokeeu.siwoplayer.data.database.TransitionRuleEntity { *; }
...
-keep class com.kokeeu.siwoplayer.data.telegram.TelegramStreamProxy { *; }
