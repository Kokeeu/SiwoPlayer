...
import com.kokeeu.siwoplayer.data.database.SongEntity // Necesario para datos de prueba
import com.kokeeu.siwoplayer.data.database.AlbumEntity
import com.kokeeu.siwoplayer.data.database.ArtistEntity
import com.kokeeu.siwoplayer.data.model.Song // Para verificar el mapeo
...
class MusicRepositoryImplTest {
    ...
    private val mockTelegramCacheManager: com.kokeeu.siwoplayer.data.telegram.TelegramCacheManager = mockk(relaxed = true)
    private val mockTelegramRepository: com.kokeeu.siwoplayer.data.telegram.TelegramRepository = mockk(relaxed = true)
    private val mockTelegramCacheManagerProvider: Lazy<com.kokeeu.siwoplayer.data.telegram.TelegramCacheManager> = mockk()
    private val mockTelegramRepositoryProvider: Lazy<com.kokeeu.siwoplayer.data.telegram.TelegramRepository> = mockk()
