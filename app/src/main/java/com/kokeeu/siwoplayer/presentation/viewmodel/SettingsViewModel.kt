...
import com.kokeeu.siwoplayer.data.backup.BackupManager
...
import com.kokeeu.siwoplayer.data.backup.model.RestoreResult
import com.kokeeu.siwoplayer.data.backup.model.ValidationError
...
import com.kokeeu.siwoplayer.data.database.AiUsageEntity
...
import com.kokeeu.siwoplayer.data.ai.GeminiModel
import com.kokeeu.siwoplayer.data.ai.provider.AiClientFactory
import com.kokeeu.siwoplayer.data.ai.provider.AiProvider
import com.kokeeu.siwoplayer.data.preferences.LaunchTab
import com.kokeeu.siwoplayer.data.model.Song
import com.kokeeu.siwoplayer.data.service.player.HiFiCapabilityChecker
...
class SettingsViewModel @Inject constructor(
    ...
    private val geminiModelService: com.kokeeu.siwoplayer.data.ai.GeminiModelService,
            ...
            try {
                ...
                val models = if (provider == AiProvider.GEMINI) {
                    ...
                    aiClient.getAvailableModels(apiKey)
                        ...
                        .distinct()
                        .map { com.kokeeu.siwoplayer.data.ai.GeminiModel(it, formatModelDisplayName(it)) }
                }
    ...
    fun setAlbumArtCacheLimitMb(limitMb: Int) {
        viewModelScope.launch {
            ...
            com.kokeeu.siwoplayer.utils.AlbumArtCacheManager.configuredCacheLimitMb = limitMb.toLong()
        }
    }
