...
import com.kokeeu.siwoplayer.data.DailyMixManager
import com.kokeeu.siwoplayer.data.model.Playlist
import com.kokeeu.siwoplayer.data.model.SmartPlaylistRule
import com.kokeeu.siwoplayer.data.model.Song
import com.kokeeu.siwoplayer.data.model.SortOption
import com.kokeeu.siwoplayer.data.playlist.M3uManager
...
import com.kokeeu.siwoplayer.data.preferences.TelegramTopicDisplayMode
import com.kokeeu.siwoplayer.data.ai.AiPlaylistGenerator
...
class PlaylistViewModel @Inject constructor(
    ...
    private fun findFolder(
        targetPath: String,
        folders: List<com.kokeeu.siwoplayer.data.model.MusicFolder>
    ): com.kokeeu.siwoplayer.data.model.MusicFolder? {
        val queue: ArrayDeque<com.kokeeu.siwoplayer.data.model.MusicFolder> = ArrayDeque(folders)
    ...
    private fun com.kokeeu.siwoplayer.data.model.MusicFolder.collectAllSongs(): List<Song> {
    ...
    private fun sortPlaylistsList(
        playlists: List<com.kokeeu.siwoplayer.data.model.Playlist>,
        sortOption: SortOption
    ): List<com.kokeeu.siwoplayer.data.model.Playlist> {
        return when (sortOption) {
            SortOption.PlaylistNameAZ -> playlists.sortedWith(
                compareBy<com.kokeeu.siwoplayer.data.model.Playlist> { it.name.lowercase() }
                    .thenByDescending { it.lastModified }
                    .thenBy { it.id }
            )
            SortOption.PlaylistNameZA -> playlists.sortedWith(
                compareByDescending<com.kokeeu.siwoplayer.data.model.Playlist> { it.name.lowercase() }
                    .thenByDescending { it.lastModified }
                    .thenBy { it.id }
            )
            SortOption.PlaylistDateCreated -> playlists.sortedWith(
                compareByDescending<com.kokeeu.siwoplayer.data.model.Playlist> { it.lastModified }
                    .thenBy { it.name.lowercase() }
                    .thenBy { it.id }
            )
            SortOption.PlaylistDateCreatedAsc -> playlists.sortedWith(
                compareBy<com.kokeeu.siwoplayer.data.model.Playlist> { it.lastModified }
                    .thenBy { it.name.lowercase() }
                    .thenBy { it.id }
            )
