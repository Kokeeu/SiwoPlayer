...
import com.kokeeu.siwoplayer.data.repository.NoLyricsFoundException
...
class LyricsStateHolder @Inject constructor(
    ...
    fun initialize(
        ...
        stablePlayerState: StateFlow<com.kokeeu.siwoplayer.presentation.viewmodel.StablePlayerState>
    ) {
