...
import com.kokeeu.siwoplayer.data.media.ImageCacheManager
import com.kokeeu.siwoplayer.data.media.MetadataEditError
...
import com.kokeeu.siwoplayer.utils.FileDeletionUtils
import com.kokeeu.siwoplayer.utils.LyricsUtils
import com.kokeeu.siwoplayer.utils.MediaItemBuilder
import com.kokeeu.siwoplayer.utils.MediaStorePermissionHelper
    ...
    suspend fun saveMetadata(
        ...
        val finalCoverArtUpdate = if (coverArtUpdate == null) {
            val existingMetadata = try {
                 com.kokeeu.siwoplayer.data.media.AudioMetadataReader.read(java.io.File(song.path))
            } catch (e: Exception) {
                null
            }
