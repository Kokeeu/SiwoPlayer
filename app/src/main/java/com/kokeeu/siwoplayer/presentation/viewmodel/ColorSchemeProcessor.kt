...
import com.kokeeu.siwoplayer.data.database.AlbumArtThemeEntity
import com.kokeeu.siwoplayer.data.database.StoredColorSchemeValues
import com.kokeeu.siwoplayer.data.database.toComposeColor
import com.kokeeu.siwoplayer.utils.LocalArtworkUri
import com.kokeeu.siwoplayer.ui.theme.clearExtractedColorCache
import com.kokeeu.siwoplayer.ui.theme.extractSeedColor
import com.kokeeu.siwoplayer.ui.theme.generateColorSchemeFromSeed
        ...
        try {
            ...
            val schemePair = withContext(Dispatchers.Default) {
                val seed = extractSeedColor(
                    bitmap = bitmap,
                    config = com.kokeeu.siwoplayer.ui.theme.ColorExtractionConfig(
