...
import com.kokeeu.siwoplayer.data.diagnostics.AdvancedPerformanceDiagnosticsController
...
import com.kokeeu.siwoplayer.presentation.viewmodel.LibraryStateHolder
import com.kokeeu.siwoplayer.presentation.viewmodel.ThemeStateHolder
...
import com.kokeeu.siwoplayer.utils.MediaMetadataRetrieverPool
...
class PixelPlayApplication : Application(), ImageLoaderFactory, Configuration.Provider {
    ...
    @Inject
    lateinit var telegramCoilFetcherFactory: dagger.Lazy<com.kokeeu.siwoplayer.data.image.TelegramCoilFetcher.Factory>

    @Inject
    lateinit var navidromeCoilFetcherFactory: dagger.Lazy<com.kokeeu.siwoplayer.data.image.NavidromeCoilFetcher.Factory>

    @Inject
    lateinit var jellyfinCoilFetcherFactory: dagger.Lazy<com.kokeeu.siwoplayer.data.image.JellyfinCoilFetcher.Factory>

    @Inject
    lateinit var localArtworkCoilFetcherFactory: dagger.Lazy<com.kokeeu.siwoplayer.data.image.LocalArtworkCoilFetcher.Factory>
