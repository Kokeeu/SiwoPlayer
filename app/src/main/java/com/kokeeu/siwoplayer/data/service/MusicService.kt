package com.kokeeu.siwoplayer.data.service
...
import com.kokeeu.siwoplayer.MainActivity
import com.kokeeu.siwoplayer.R
import com.kokeeu.siwoplayer.data.diagnostics.PerformanceMetrics
import com.kokeeu.siwoplayer.data.model.PlayerInfo
import com.kokeeu.siwoplayer.data.model.PlaybackQueueItemSnapshot
import com.kokeeu.siwoplayer.data.model.PlaybackQueueSnapshot
import com.kokeeu.siwoplayer.data.preferences.EqualizerPreferencesRepository
...
import com.kokeeu.siwoplayer.data.service.player.TransitionController
import com.kokeeu.siwoplayer.ui.glancewidget.PlayerActions
import com.kokeeu.siwoplayer.utils.AlbumArtUtils
...
import com.kokeeu.siwoplayer.data.equalizer.EqualizerManager
import com.kokeeu.siwoplayer.data.model.WidgetThemeColors
import com.kokeeu.siwoplayer.data.preferences.AlbumArtColorAccuracy
import com.kokeeu.siwoplayer.data.preferences.AlbumArtPaletteStyle
import com.kokeeu.siwoplayer.presentation.viewmodel.ColorSchemeProcessor
import androidx.compose.ui.graphics.toArgb
import androidx.compose.material3.dynamicDarkColorScheme
import androidx.compose.material3.dynamicLightColorScheme
import com.kokeeu.siwoplayer.data.preferences.ThemePreference
import com.kokeeu.siwoplayer.data.service.auto.AutoMediaBrowseTree
import com.kokeeu.siwoplayer.data.service.wear.buildWearThemePalette
import com.kokeeu.siwoplayer.data.service.wear.WearStatePublisher
import com.kokeeu.siwoplayer.presentation.viewmodel.ColorSchemePair
import com.kokeeu.siwoplayer.shared.WearIntents
import com.kokeeu.siwoplayer.utils.ArtworkTransportSanitizer
import com.kokeeu.siwoplayer.utils.MediaItemBuilder
import com.kokeeu.siwoplayer.data.navidrome.NavidromeRepository
import com.kokeeu.siwoplayer.di.AppScope
import com.kokeeu.siwoplayer.presentation.viewmodel.ListeningStatsTracker
...
class MusicService : MediaLibraryService() {
    ...
    @Inject
    lateinit var replayGainManager: com.kokeeu.siwoplayer.data.media.ReplayGainManager
    @Inject
    ...
    companion object {
        ...
        const val ACTION_SLEEP_TIMER_EXPIRED = "com.kokeeu.siwoplayer.ACTION_SLEEP_TIMER_EXPIRED"
        const val EXTRA_FORCE_FOREGROUND_ON_START =
            "com.kokeeu.siwoplayer.extra.FORCE_FOREGROUND_ON_START"
        ...
        private const val APP_PACKAGE_PREFIX = "com.kokeeu.siwoplayer"
    ...
    private suspend fun buildPlayerInfo(): PlayerInfo {
        ...
        val queueItems = mutableListOf<com.kokeeu.siwoplayer.data.model.QueueItem>()
        ...
        if (!snapshotTimeline.isEmpty) {
            ...
            for (i in startIndex until endIndex) {
                ...
                if (songId != null) {
                    ...
                    queueItems.add(
                        com.kokeeu.siwoplayer.data.model.QueueItem(
                            id = songId,
    ...
    private suspend fun resolveWearLyrics(mediaId: String?): com.kokeeu.siwoplayer.data.model.Lyrics? {
    ...
    public suspend fun loadArtworkBytesForWidget(uri: Uri): ByteArray? {
        ...
        val isLocalArtworkUri = com.kokeeu.siwoplayer.utils.LocalArtworkUri.isLocalArtworkUri(uriString)
        return when {
