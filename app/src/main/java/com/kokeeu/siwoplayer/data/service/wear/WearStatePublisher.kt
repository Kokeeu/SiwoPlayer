...
import com.kokeeu.siwoplayer.shared.WearLyrics
...
class WearStatePublisher @Inject constructor(
    ...
    private fun resolveArtworkBytesForWear(playerInfo: PlayerInfo): ByteArray? {
        ...
        if (!uriString.isNullOrBlank()) {
            ...
            when {
                com.kokeeu.siwoplayer.utils.LocalArtworkUri.isLocalArtworkUri(uriString) ||
                    scheme == "content" ||
                    scheme == "file" ||
    ...
    private fun com.kokeeu.siwoplayer.data.model.Lyrics.toWearLyrics(
