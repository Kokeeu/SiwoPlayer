package com.kokeeu.siwoplayer.data.ai
...
import com.kokeeu.siwoplayer.data.database.AiCacheEntity
...
class AiHandler @Inject constructor(
    ...
    private suspend fun generateWithRecovery(
        ...
        suspend fun callWithModel(model: String): String {
            return try {
                ...
                throw com.kokeeu.siwoplayer.data.ai.provider.AiProviderSupport.createException(
        ...
        return try {
            ...
            val failure = com.kokeeu.siwoplayer.data.ai.provider.AiProviderSupport.wrapThrowable(
    ...
    private suspend fun recoverModelIfNeeded(
        ...
        client: com.kokeeu.siwoplayer.data.ai.provider.AiClient,
        failure: com.kokeeu.siwoplayer.data.ai.provider.AiProviderException
    ): String? {
        ...
        val recoveredModel = com.kokeeu.siwoplayer.data.ai.provider.AiProviderSupport.selectRecoveryModel(
    ...
    suspend fun generateContent(
        ...
        val providersToTry = com.kokeeu.siwoplayer.data.ai.provider.AiProviderSupport.buildProviderChain(userProvider)
        ...
        for (provider in providersToTry) {
            ...
            try {
                ...
                val failure = com.kokeeu.siwoplayer.data.ai.provider.AiProviderSupport.wrapThrowable(provider.displayName, e)
