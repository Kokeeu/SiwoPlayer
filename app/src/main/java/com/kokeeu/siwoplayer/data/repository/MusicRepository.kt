...
interface MusicRepository {
    ...
    fun getPaginatedAlbums(
        ...
        storageFilter: com.kokeeu.siwoplayer.data.model.StorageFilter = com.kokeeu.siwoplayer.data.model.StorageFilter.ALL,
        minTracks: Int = 1
    ...
    suspend fun getFavoriteSongsPage(
        limit: Int,
        offset: Int,
        sortOption: com.kokeeu.siwoplayer.data.model.SortOption = com.kokeeu.siwoplayer.data.model.SortOption.LikedSongTitleAZ,
        storageFilter: com.kokeeu.siwoplayer.data.model.StorageFilter = com.kokeeu.siwoplayer.data.model.StorageFilter.ALL
    ): List<Song>
    ...
    suspend fun getSongsPage(
        limit: Int,
        offset: Int,
        sortOption: com.kokeeu.siwoplayer.data.model.SortOption = com.kokeeu.siwoplayer.data.model.SortOption.SongDefaultOrder,
        storageFilter: com.kokeeu.siwoplayer.data.model.StorageFilter = com.kokeeu.siwoplayer.data.model.StorageFilter.ALL
    ): List<Song>
    ...
    suspend fun getAlbumsPage(
        limit: Int,
        offset: Int,
        sortOption: com.kokeeu.siwoplayer.data.model.SortOption = com.kokeeu.siwoplayer.data.model.SortOption.AlbumTitleAZ,
        storageFilter: com.kokeeu.siwoplayer.data.model.StorageFilter = com.kokeeu.siwoplayer.data.model.StorageFilter.ALL,
        minTracks: Int = 1
    ): List<Album>
    ...
    suspend fun getArtistsPage(
        limit: Int,
        offset: Int,
        sortOption: com.kokeeu.siwoplayer.data.model.SortOption = com.kokeeu.siwoplayer.data.model.SortOption.ArtistNameAZ,
        storageFilter: com.kokeeu.siwoplayer.data.model.StorageFilter = com.kokeeu.siwoplayer.data.model.StorageFilter.ALL
    ): List<Artist>
     ...
     */
    fun getGenres(): Flow<List<com.kokeeu.siwoplayer.data.model.Genre>>
    ...
    fun getMusicFolders(
        storageFilter: com.kokeeu.siwoplayer.data.model.StorageFilter = com.kokeeu.siwoplayer.data.model.StorageFilter.ALL
    ): Flow<List<com.kokeeu.siwoplayer.data.model.MusicFolder>>
    ...
    suspend fun saveTelegramTopics(chatId: Long, topics: List<com.kokeeu.siwoplayer.data.database.TelegramTopicEntity>)
    /** Replaces the full topic list for a channel, deleting any topics that no longer exist. */
    suspend fun replaceTopicsForChannel(chatId: Long, freshTopics: List<com.kokeeu.siwoplayer.data.database.TelegramTopicEntity>)
    suspend fun getTopicsForChannel(chatId: Long): List<com.kokeeu.siwoplayer.data.database.TelegramTopicEntity>
    fun getAllTelegramTopics(): Flow<List<com.kokeeu.siwoplayer.data.database.TelegramTopicEntity>>
    suspend fun replaceTelegramSongsForTopic(chatId: Long, threadId: Long, topicName: String, songs: List<Song>)

    val telegramRepository: com.kokeeu.siwoplayer.data.telegram.TelegramRepository
