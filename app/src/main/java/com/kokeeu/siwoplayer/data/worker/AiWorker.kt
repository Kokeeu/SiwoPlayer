...
import com.kokeeu.siwoplayer.data.ai.AiNotificationManager
import com.kokeeu.siwoplayer.data.ai.AiHandler
import com.kokeeu.siwoplayer.data.ai.AiSystemPromptType
import com.kokeeu.siwoplayer.data.ai.UserProfileDigestGenerator
...
class AiWorker @AssistedInject constructor(
    ...
    private val preferencesRepo: com.kokeeu.siwoplayer.data.preferences.AiPreferencesRepository
