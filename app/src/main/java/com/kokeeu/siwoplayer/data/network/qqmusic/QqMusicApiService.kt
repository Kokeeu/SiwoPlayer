package com.kokeeu.siwoplayer.data.network.qqmusic
...
class QqMusicApiService @Inject constructor(
    ...
    private val okHttpClient: OkHttpClient = baseOkHttpClient.newBuilder()
        ...
        .addInterceptor(com.kokeeu.siwoplayer.data.remote.qqmusic.QQMusicEncryptInterceptor(
            com.kokeeu.siwoplayer.data.remote.qqmusic.QQSignGenerator(context)
        ))
