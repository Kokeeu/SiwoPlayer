...
import com.kokeeu.siwoplayer.BuildConfig
import com.kokeeu.siwoplayer.PixelPlayApplication
import com.kokeeu.siwoplayer.data.database.AlbumArtThemeDao
import com.kokeeu.siwoplayer.data.database.EngagementDao
import com.kokeeu.siwoplayer.data.database.FavoritesDao
import com.kokeeu.siwoplayer.data.database.GDriveDao
import com.kokeeu.siwoplayer.data.database.LyricsDao
import com.kokeeu.siwoplayer.data.database.AiCacheDao
import com.kokeeu.siwoplayer.data.database.AiUsageDao
import com.kokeeu.siwoplayer.data.database.LocalPlaylistDao
import com.kokeeu.siwoplayer.data.database.MusicDao
import com.kokeeu.siwoplayer.data.database.PixelPlayDatabase
import com.kokeeu.siwoplayer.data.database.SearchHistoryDao
import com.kokeeu.siwoplayer.data.database.TransitionDao
import com.kokeeu.siwoplayer.data.preferences.UserPreferencesRepository
import com.kokeeu.siwoplayer.data.preferences.PlaylistPreferencesRepository
import com.kokeeu.siwoplayer.data.preferences.dataStore
import com.kokeeu.siwoplayer.data.media.SongMetadataEditor
import com.kokeeu.siwoplayer.data.network.deezer.DeezerApiService
import com.kokeeu.siwoplayer.data.network.netease.NeteaseApiService
import com.kokeeu.siwoplayer.data.network.lyrics.LrcLibApiService
import com.kokeeu.siwoplayer.data.repository.ArtistImageRepository
import com.kokeeu.siwoplayer.data.repository.LyricsRepository
import com.kokeeu.siwoplayer.data.repository.LyricsRepositoryImpl
import com.kokeeu.siwoplayer.data.repository.MediaStoreSongRepository
import com.kokeeu.siwoplayer.data.repository.MusicRepository
import com.kokeeu.siwoplayer.data.repository.MusicRepositoryImpl
import com.kokeeu.siwoplayer.data.repository.SongRepository
import com.kokeeu.siwoplayer.data.repository.TransitionRepository
import com.kokeeu.siwoplayer.data.repository.TransitionRepositoryImpl
import com.kokeeu.siwoplayer.data.repository.FolderTreeBuilder
...
object AppModule {
    ...
    fun provideSessionToken(@ApplicationContext context: Context): androidx.media3.session.SessionToken {
        return androidx.media3.session.SessionToken(
            context,
            android.content.ComponentName(context, com.kokeeu.siwoplayer.data.service.MusicService::class.java)
        )
    }
    ...
    @Singleton
    @Provides
    fun provideQqMusicDao(database: PixelPlayDatabase): com.kokeeu.siwoplayer.data.database.QqMusicDao {
        return database.qqmusicDao()
    }

    @Singleton
    @Provides
    fun provideNavidromeDao(database: PixelPlayDatabase): com.kokeeu.siwoplayer.data.database.NavidromeDao {
    ...
    @Singleton
    @Provides
    fun provideJellyfinDao(database: PixelPlayDatabase): com.kokeeu.siwoplayer.data.database.JellyfinDao {
    ...
    fun provideSongRepository(
        @ApplicationContext context: Context,
        mediaStoreObserver: com.kokeeu.siwoplayer.data.observer.MediaStoreObserver,
    ...
    @Singleton
    @Provides
    fun provideTelegramDao(database: PixelPlayDatabase): com.kokeeu.siwoplayer.data.database.TelegramDao {
        return database.telegramDao()
    }

    @Singleton
    @Provides
    fun provideNeteaseDao(database: PixelPlayDatabase): com.kokeeu.siwoplayer.data.database.NeteaseDao {
    ...
    fun provideMusicRepository(
        ...
        telegramDao: com.kokeeu.siwoplayer.data.database.TelegramDao,
        telegramCacheManager: Lazy<com.kokeeu.siwoplayer.data.telegram.TelegramCacheManager>,
        telegramRepository: Lazy<com.kokeeu.siwoplayer.data.telegram.TelegramRepository>,
